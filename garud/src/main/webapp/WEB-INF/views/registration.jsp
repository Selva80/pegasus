	...
	<div class="row">
        <div class="col-md-9 col-md-offset-1">
            ...
            <label for="phone">Enter your current Mobile Number: </label>
                    ...
                    <form:input  path = "phone"  type="text" name="phonenumber" id="phone" class="form-control phone" maxlength="28" onkeyup="validatephone(this);" placeholder="Phone Number"/> 
            ...
            <div class="form-group"> 	 
                <label for="cFirstName"><i class="fa-id-card-o"></i>Enter your First name: </label>
                    ...
                    <form:input  path="cFirstName" class="form-control" type="text" name="firstname" id = "txt" placeholder="First Name" onkeyup = "Validate(this)"  /> 
            ...
            <div class="form-group">
                <label for="cLastName">Enter your Last name: </label> 
                    ...
                    <form:input path="cLastName" class="form-control" type="text" name="lastname" id = "txt" onkeyup = "Validate(this)" placeholder="Last Name"  />  
            ...
            <div class="form-group">
                <label for="cEmail">Enter the Email Address: </label>
                    ...
                    <form:input path="cEmail" class="form-control"  placeholder="Email" type="text" name="email" id = "email"  onchange="email_validate(this.value);" />   
